import { resolveComponent, openBlock, createElementBlock, Fragment, createCommentVNode, createBlock } from 'vue';
    ...
    computed: {
        snakeCaseValue() {
            if (this.relatedField)
                return snakeCase$1(this.values[this.relatedField]);
            else return "";
        },
    },
    watch: {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    createCommentVNode(" Derived from label field  "),
    ($props.relatedField)
      ? (openBlock(), createBlock(_component_VInput, {
          key: 0,
          "model-value": $options.snakeCaseValue,
          disabled: true
        }, null, 8 /* PROPS */, ["model-value"]))
      : (openBlock(), createElementBlock("p", _hoisted_1, "Please select Related Field")),
    createCommentVNode(" Editable  "),
    createCommentVNode(" <VInput\n    :model-value=\"value\"\n    @update:model-value=\"handleChange($event)\"\n    v-if=\"isEditable\"\n  /> ")
